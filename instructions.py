...
class Instructions:
	...
	def set_instructions(self, language, Targeted_duration, N_repeats):
		if language == 'German':
			...
			self.font_explain_trials = f'Jede Wiederholung startet mit einem Teil TETRIS SPIELEN, gefolgt von einem zufällig gewählten Teil TETRIS ZUZUSCHAUEN, TASTENDRÜCKEN oder FIXATIONSKREUZ! Jeder Teil dauert {Targeted_duration} Sekunden und es gibt {N_repeats * 3} Wiederholungen!'
