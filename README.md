...
**"Pre-Trial" specific:**
	...
	- "play_pretrial.start_level": Level at which the Tetris round started.
	- "play_pretrial.fail_level" : Level at which the Tetris round was finished.    
    - "pretrial_score": Score obtained in the "pre_Trials"/per round.
	- "pretrial_level_avg": Mean level reached in the "pre_Trials".\
\
**If you use either of the "Comp_speed" and/or "Speed_seed" from [config_paradigm_psychopy ](config_paradigm_psychopy.txt), you will get additional parameters:**
