...
Score system: down_key = 1 Score Point
...
In the folder containing the game there are 7 files besides the Readme
	...
	3. game.py contains the game mechnanics such as moving the blocks, score, difficulty, game reset...
	   Code from config.txt is executed here 
