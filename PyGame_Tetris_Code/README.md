...
## In this folder containing the game there are 7 files besides the README:
1. the main game loop can be found in the [Tetris_Psychopy.psyexp](../Tetris_Psychopy.psyexp) file as "Tetris_Instance()" in the "load_processes" routine!
...
3. [game.py](game.py) contains the game mechnanics such as moving the blocks, score, difficulty, game reset...; Code of [config_tetris_game.txt](config_tetris_game.txt) is executed here.
